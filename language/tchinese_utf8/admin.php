...
define('_MA_TCW_WEB_NOTICE', '全域通知');
define('_MA_TADWEB_NOTICEWHO_DEF', '網站管理員');
define('_MA_TADWEB_NOTICEID', '通知編號');
define('_MA_TADWEB_NOTICETITLE', '通知標題');
define('_MA_TADWEB_NOTICECONTENT', '通知內容');
define('_MA_TADWEB_NOTICEWEB', '通知網站');
define('_MA_TADWEB_NOTICEWHO', '通知對象');
define('_MA_TADWEB_NOTICEWHO_DEF0', '網站管理員');
define('_MA_TADWEB_NOTICEWHO_DEF1', '網站成員');
define('_MA_TADWEB_NOTICEWHO_DEF2', '家長');
define('_MA_TADWEB_NOTICEDATE', '通知日期');

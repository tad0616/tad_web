...
define("_MD_TCW_NOT_OWNER","非網頁擁有者，無法使用新增功能。");
...
define("_MD_TCW_UPLOAD_MY_PHOTO","照片");
...
define("_MD_TCW_CLASS_SETUP","班級設定");
define("_MD_TCW_FCNCTION_SETUP","功能設定");
define("_MD_TCW_HEADER_SETUP","標題設定");
define("_MD_TCW_SELECT_TO_CANCEL","請將想要隱藏的功能打勾");
define("_MD_TCW_CLICK_TO_CHANG","直接點選圖片即可完成選定網頁標題背景圖");
...
define("_MD_TCW_HOMEWORK_DEFAULT","<h3>【今日作業】</h3><ol><li>&nbsp;</li></ol><h3>【明日準備事項】</h3><ol><li>&nbsp;</li></ol><p>&nbsp;</p>");
...
//calenda.php
define("_MD_TCW_CALENDA","行事曆");
define("_MD_TCW_CALENDA_TODAY","今天");
define("_MD_TCW_CALENDA_PREV_MONTH","上個月");
define("_MD_TCW_CALENDA_NEXT_MONTH","下個月");

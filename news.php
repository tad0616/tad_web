...
$xoopsOption['template_main'] = "tad_web_news_tpl.html";

if(!defined('_NEWS_KIND'))define("_NEWS_KIND","news");
if(!defined('_NEWS_TOCAL_DESC'))define("_NEWS_TOCAL_DESC",_MD_TCW_NEWS_TO_CAL);
if(!defined('_SHOW_NEWS_PLACE'))define("_SHOW_NEWS_PLACE",false);
if(!defined('_SHOW_NEWS_MASTER'))define("_SHOW_NEWS_MASTER",false);
if(!defined('_SHOW_NEWS_URL'))define("_SHOW_NEWS_URL",true);
if(!defined('_SHOW_NEWS_TOCAL'))define("_SHOW_NEWS_TOCAL",true);
if(!defined('_USE_NEWS_FORM_DATETIME'))define("_USE_NEWS_FORM_DATETIME",false);
if(!defined('_USE_FCKEDITOR'))define("_USE_FCKEDITOR",true);
if(!defined('_NEWS_NL2BR'))define("_NEWS_NL2BR",false);
if(!defined('_SHOW_FULLCALENDAR'))define("_SHOW_FULLCALENDAR",false);
if(!defined('_SHOW_FULLCALENDAR_COLNAME'))define("_SHOW_FULLCALENDAR_COLNAME","NewsDate");
if(!defined('_SHOW_NEWS_UPLOAD'))define("_SHOW_NEWS_UPLOAD",true);
...
function show_one_tad_web_news($NewsID="",$show_place=false,$nl2br=false){
	...
	if(empty($uid))redirect_header('index.php',3,_MD_TCW_NEWS_NOT_EXIST);
...
$NewsID=(empty($_REQUEST['NewsID']))?"":intval($_REQUEST['NewsID']);
...
switch($op){
  ...
  header("location: {$_SERVER['PHP_SELF']}?NewsID=$NewsID");
  break;

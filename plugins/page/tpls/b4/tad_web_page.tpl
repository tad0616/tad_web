<{if $op=="edit_form"}>
  ...
  <div class="card card-body bg-light m-1">
    <form page="page.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
...
<{elseif $page_data}>
  <div class="row">
    <div class="col-md-12">
      <{includeq file="$xoops_rootpath/modules/tad_web/plugins/page/tpls/b4/tad_web_common_page.tpl"}>
    </div>
  </div>
<{elseif $op=="setup"}>

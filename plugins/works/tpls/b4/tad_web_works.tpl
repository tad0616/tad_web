<{if $op=="edit_form"}>
  ...
  <div class="card card-body bg-light m-1">
    <form action="works.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
      ...
      <!--作品日期-->
      <div class="form-group row">
        <label class="col-md-2 col-form-label text-sm-right" id="works_date_label">
          <{if $WorksKind!=""}>
...
<{elseif $op=="show_one"}>
  ...
  <{if $WorkDesc}>
    <div class="card card-body bg-light m-1"><{$WorkDesc}></div>
  <{/if}>
  <div class="row">
    <{$pics}>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <{if $isMyWeb and $WebID}>
          <a href="cate.php?WebID=<{$WebID}>&ColName=works&table=tad_web_works" class="btn btn-warning <{if $web_display_mode=='index'}>btn-sm<{/if}>"><i class="fa fa-folder-open"></i> <{$smarty.const._MD_TCW_CATE_TOOLS}></a>

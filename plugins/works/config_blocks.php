...
$blocksArr['list_work']['colset']['limit'] = ['label' => _MD_TCW_WORK_BLOCK_LIMIT, 'type' => 'text'];
...
$blocksArr['random_work']['colset']['limit'] = ['label' => _MD_TCW_WORK_BLOCK_LIMIT, 'type' => 'text'];
...
$blocksArr['latest_work']['colset']['limit'] = ['label' => _MD_TCW_WORK_BLOCK_LIMIT, 'type' => 'text'];

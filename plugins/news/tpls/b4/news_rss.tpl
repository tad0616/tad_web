...
<{if $bc.main_data}>
  ...
  <div class="row">
    <div class="col-md-7">
      <a href="<{if $bc.config.feed_url!=""}><{$bc.config.feed_url}><{else}><{$xoops_url}>/modules/tad_web/rss.php?WebID=<{$bc.WebID}><{/if}>" target="_blank" style="font-size:11px; "><img src="<{$xoops_url}>/modules/tad_web/plugins/news/images/rss.png" alt="rss" style="float:left; margin-right:3px;"><{$smarty.const._MD_TCW_NEWS_BLOCK_RSS_LINK}></a>
    </div>
    <div class="col-md-5 text-right">
      <a href="http://feed.mikle.com/" target="_blank" style="color:#CCCCCC;font-size:10px;">RSS Feed Widget</a>
    </div>

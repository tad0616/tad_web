<{if $news_data}>
      ...
      <div class="row">
        <div class="col-md-12">
          <{if $news.NewsContent}>
            ...
            <div class="card card-body bg-light m-1 list_new" style="min-height: 100px; overflow: auto; line-height: 1.8; ">
  ...
  <div style="text-align:right; margin: 0px 0px 10px;">
    <{if $web_display_mode=='index'}>
      <a href="news.php" class="btn btn-primary <{if $web_display_mode=='index'}>btn-sm<{/if}>"><i class="fa fa-info-circle"></i> <{$smarty.const._MD_TCW_MORE}><{$smarty.const._MD_TCW_NEWS_SHORT}></a>
    <{elseif $web_display_mode=='home' or $NewsDefCateID}>
      <a href="news.php?WebID=<{$WebID}>" class="btn btn-primary <{if $web_display_mode=='index'}>btn-sm<{/if}>"><i class="fa fa-info-circle"></i> <{$smarty.const._MD_TCW_MORE}><{$smarty.const._MD_TCW_NEWS_SHORT}></a>
    <{/if}>

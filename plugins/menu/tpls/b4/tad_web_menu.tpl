<{if $op=="edit_form"}>
  ...
  <div class="card card-body bg-light m-1">
    <form action="menu.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-3">
          <div class="form-check form-check-inline">
            <input class="form-check-input" id="Target" type="checkbox" name="Target" value="_balnk">
            <label class="form-check-label" for="Target"><{$smarty.const._MD_TCW_MENU_TARGET_BLANK}></label>
          </div>
        </div>
      </div>

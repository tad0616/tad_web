...
define("_MD_TCW_FILES_BLOCK_LIMIT", "顯示檔案數量");
define("_MD_TCW_FILES_METHOD", "加入檔案方式");
define("_MD_TCW_FILES_LINK", "外部檔案連結");
define("_MD_TCW_FILES_LINK_DESC", "請填入完整的檔案下載網址，如：http://xxx.xx.xx/ooo.pdf");
define("_MD_TCW_FILES_DESC", "檔案說明或檔名");

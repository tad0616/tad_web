  ...
  <div class="card card-body bg-light m-1">
    <form schedule="schedule.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label text-sm-right"><{$smarty.const._MD_TCW_SCHEDULENAME}></label>
        <div class="col-md-10">
        ...
        <div class="form-group row">
          <div class="col-md-12">
            <div class="alert alert-warning">
              ...
              <div style="clear: both;" class="text-right"><a href="schedule.php?WebID=<{$WebID}>&op=setup_subject&ScheduleID=<{$ScheduleID}>" class="btn btn-sm btn-info"><{$smarty.const._MD_TCW_SCHEDULE_SETUP_SUBJECT}></a></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="ScheduleDisplay">
              <{$smarty.const._MD_TCW_SCHEDULE_SET_DEFAULT}><span class="text-danger"><{$smarty.const._MD_TCW_SCHEDULE_SET_DEFAULT_DESC}></span></label>
          </div>
        </div>
      </div>
        ...
        <{foreach from=$schedule_subjects_arr key=i item=subject}>
          <tr id="item_form<{$i}>">
            ...
            <td id="demo_<{$i}>" style="text-align: center; vertical-align: middle; color: <{$subject.color}>; background-color: <{$subject.bg_color}>;">
              ...
              <div id="Teacher_demo_<{$i}>" style="font-size: 75%;"><{$subject.Teacher}></div>

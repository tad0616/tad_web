<{if $op=="edit_form"}>
  ...
  <div class="card card-body bg-light m-1">
    <form action="homework.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
      <!--分類-->
      <{$cate_menu_form}>
...
<{elseif $op=="list_all"}>
  <{if $WebID}>
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <{if $isCanEdit}>
          <a href="cate.php?WebID=<{$WebID}>&ColName=homework&table=tad_web_homework" class="btn btn-warning <{if $web_display_mode=='index'}>btn-sm<{/if}>"><i class="fa fa-folder-open"></i> <{$smarty.const._MD_TCW_CATE_TOOLS}></a>
  ...
  <{includeq file="$xoops_rootpath/modules/tad_web/plugins/calendar/tpls/b4/tad_web_common_calendar.tpl"}>
<{elseif $op=="setup"}>

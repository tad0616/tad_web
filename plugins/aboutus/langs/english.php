...
define('_MD_TCW_ALL_WEB_TITLE', 'Class Name');
...
define('_MD_TCW_IMPORT_EXCEL', 'Import %s data as Excel file');
...
define('_MD_TCW_ABOUTUS_S1_TEXT', 'The "teacher" to');
define('_MD_TCW_ABOUTUS_S1_DESC', 'The "teacher" is replaced by the new string, for example: administrator, leader, president and so on.');
define('_MD_TCW_ABOUTUS_S1_DEFAULT', 'teacher');
define('_MD_TCW_ABOUTUS_S2_TEXT', 'The "class" to');
define('_MD_TCW_ABOUTUS_S2_DESC', 'The "class" is replaced by the new string, for example: site, team, club and so on。');

<h3><a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$cate.CateID}>"><{$cate.CateName}></a> <{$smarty.const._MD_TCW_STUDENT_POSITION}></h3>

<form class="form-horizontal" role="form">
  <div class="row">
    <div class="col-sm-9"><{$cate_menu}></div>
    <div class="col-sm-3"><a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$cate.CateID}>&op=reset_position" class="btn btn-primary"><{$smarty.const._MD_TCW_ABOUT_RESET}></a></div>
  </div>
</form>
<{if $isMyWeb}>

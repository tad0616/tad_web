        ...
        <{foreach from=$all_mems item=stud}>
          <tr>
            ...
            <{if $isMyWeb}>
              ...
              <{/if}>
              <td style="text-align: center;"><a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$CateID}>&MemID=<{$stud.MemID}>&op=edit_stu" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a></td>
            <{/if}>
          </tr>
        <{/foreach}>
      </table>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div style="margin: 2px;">
              ...
              <{if $isMyWeb}>
                <a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$cate.CateID}>&MemID=<{$stud.MemID}>&op=show_stu"><{$stud.MemName}></a>
                <a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$CateID}>&MemID=<{$stud.MemID}>&op=edit_stu" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a>
              <{else}>
                <{$stud.MemName}>
              <{/if}>
            </div>
...
<{elseif ($op=="edit_form" or $op=="new_class") and $isMyWeb}>
  ...
  <{if $op=="new_class" or $now_cate}>
    <form action="aboutus.php?WebID=<{$WebID}>" method="post" enctype="multipart/form-data" role="form">
      <h3><{$class_setup}></h3>
      <div class="row">
        <div class="col-md-4">
          <{if $class_pic_thumb}>
        ...
        <{foreach from=$old_cate item=cate}>
          <tr id="CateID_<{$cate.CateID}>">
            ...
            <td style="text-align: center;">
              ...
              <a href="aboutus.php?WebID=<{$WebID}>&CateID=<{$cate.CateID}>&op=edit_class_stu" class="btn btn-sm btn-info"><{$edit_student}></a>
            </td>
          </tr>
        <{/foreach}>
      </tbody>
...
<{elseif $op=="edit_position"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/tad_web_mem_position.tpl"}>
<{elseif $op=="edit_stu"}>

    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/tad_web_mem_form.tpl"}>
<{elseif $op=="show_stu"}>
...
<{elseif $op=="export_config"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/tad_web_export_config.tpl"}>
<{elseif $op=="parents_account"}>
  ...
  <form action="aboutus.php" id="myForm" method="post" enctype="multipart/form-data" role="form">
    <div class="form-group row">
      <label class="col-md-3 col-form-label text-sm-right">
        <{$cate_label}>
      </label>
...
<{elseif $op=="show_parent"}>
  ...
  <form action="aboutus.php?WebID=<{$WebID}>" method="post" enctype="multipart/form-data" role="form">
    <div class="row">
      ...
      <div class="col-md-3">
        <img src="<{$pic}>" alt="<{$mem.MemName}><{$smarty.const._MD_TCW_ABOUTUS_S}><{$parent.Reationship}>" class="img-fluid rounded">
        <br>
      ...
      <div class="col-md-3">
         <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/parent_toolbar.tpl"}>
      </div>
    </div>
  </form>
...
<{elseif $op=="mem_slot"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/tad_web_mem_slot.tpl"}>
<{else}>

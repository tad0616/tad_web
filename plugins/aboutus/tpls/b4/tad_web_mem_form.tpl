...
<div class="row">
  ...
  <div class="col-md-8">
    <form action="aboutus.php" method="post" id="myForm" enctype="multipart/form-data" role="form">
      <!--學生相片-->
      ...
      <{else}>
        ...
        <div class="alert alert-info">
          <!--學生姓名-->
          <div class="form-group row">
            <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_NAME}></label>
            <div class="col-md-9">
          ...
          <!--性別-->
          <div class="form-group row">
            <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_SEX}></label>
            <div class="col-md-9">
          ...
          <!--是否還在班上-->
          <div class="form-group row">
            <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_STATUS}></label>
            <div class="col-md-9">
      ...
      <{if 'MemNum'|in_array:$mem_column}>
        ...
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_NUM}></label>
          <div class="col-md-9">
            <{if $LoginMemID}>
      ...
      <{if 'MemUnicode'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_UNICODE}></label>
          <div class="col-md-9">
            <{if $LoginMemID}>
      ...
      <{if 'MemBirthday'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_BIRTHDAY}></label>
          <div class="col-md-9">
      ...
      <{if 'MemNickName'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_NICKNAME}></label>
          <div class="col-md-9">
      ...
      <{if 'MemExpertises'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_EXPERTISES}></label>
          <div class="col-md-9">
      ...
      <{if 'MemClassOrgan'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_CLASSORGAN}></label>
          <div class="col-md-9">
      ...
      <{if 'AboutMem'|in_array:$mem_column}>
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_ABOUTME}></label>
          <div class="col-md-9">
      ...
      <div class="alert alert-warning">
        <!--帳號-->
        <div class="form-group row" >
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_UNAME}></label>
          <div class="col-md-9">
        ...
        <!--密碼-->
        <div class="form-group row">
          <label class="col-md-3 col-form-label text-sm-right"><{$smarty.const._MD_TCW_MEM_PASSWD}></label>
          <div class="col-md-9">
  ...
  <div class="col-md-4">
    <{if $LoginMemID}>
       <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/b4/mem_toolbar.tpl"}>
    <{else}>

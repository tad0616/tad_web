...
<{elseif $op=="edit_position"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/tad_web_mem_position.tpl"}>
<{elseif $op=="edit_stu"}>

    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/tad_web_mem_form.tpl"}>
<{elseif $op=="show_stu"}>
...
<{elseif $op=="export_config"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/tad_web_export_config.tpl"}>
...
<{elseif $op=="mem_slot"}>
    ...
    <{includeq file="$xoops_rootpath/modules/tad_web/plugins/aboutus/tpls/tad_web_mem_slot.tpl"}>
<{else}>
  <{$FooTableJS}>
  <div class="row">
    <div class="col-sm-12">

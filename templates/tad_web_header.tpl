<{if $WebID}>
    ...
    <{else}>
        ...
        <a href="index.php?WebID=<{$WebID}>"><img src="<{$xoops_url}>/uploads/tad_web/<{$WebID}>/header.png" alt="<{$WebTitle}>"  id="head_bg" class="img-rounded img-fluid img-resopnsive" style="margin-bottom: 10px;"><span class="sr-only"><{$WebTitle}></span></a>
    <{/if}>
<{/if}>

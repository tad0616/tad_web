...
<nav id="c-menu--slide-right" class="c-menu c-menu--slide-right">
  ...
  <div style="margin-left:10px;">
    ...
    <div class="well">
      ...
      <form action="aboutus.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id="student_login" style="display: none;">
        <div class="form-group">
          <label class="col-sm-4 control-label">
      ...
      <form action="aboutus.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id="parent_login" style="display: none;">
        <div class="form-group">
          <label class="sr-only">
          </label>
        ...
        <{if $mem_parents=='1'}>
          ...
          <div class="row">
            <div class="col-sm-12 text-center" style="font-size:12pt;">

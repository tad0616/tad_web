            ...
            <tr>
              ...
              <td>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="WebEnable" id="WebEnable_1" value="1" <{$WebEnable1}>>
                  <label class="form-check-label" for="WebEnable_1"><{$smarty.const._YES}></label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="WebEnable" id="WebEnable_0" value="0" <{$WebEnable0}>>
                  <label class="form-check-label" for="WebEnable_0"><{$smarty.const._NO}></label>
                </div>
              </td>
            </tr>

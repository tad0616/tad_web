<{if $WebID}>
  <{if $config}>
    ...
    <div class="card card-body bg-light m-1" id="web_head" style="height: 200px; overflow: hidden; padding: 0px; position: relative; border: 2px dashed red;">
  ...
  <{else}>
    <script>
      ...
      <a href="index.php?WebID=<{$WebID}>"><img src="<{$xoops_url}>/uploads/tad_web/<{$WebID}>/header.png" alt="<{$WebTitle}>" title="<{$WebTitle}>" id="head_bg" class="rounded img-fluid" style="margin-bottom: 10px;"></a>
  <{/if}>
<{/if}>

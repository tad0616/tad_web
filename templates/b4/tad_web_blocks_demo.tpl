<div class="tad_web_block">
  ...
  <{else}>
    <{if $block.BlockContent.main_data}>
      <{if "$xoops_rootpath/modules/tad_web/plugins/`$block.plugin.dirname`/tpls/b4/`$block.tpl`"|file_exists}>
        <{includeq file="$xoops_rootpath/modules/tad_web/plugins/`$block.plugin.dirname`/tpls/b4/`$block.tpl`"}>
      <{elseif "$xoops_rootpath/modules/tad_web/plugins/system/tpls/b4/`$block.tpl`"|file_exists}>
        <{includeq file="$xoops_rootpath/modules/tad_web/plugins/system/tpls/b4/`$block.tpl`"}>
      <{else}>
        no template<br>
        <{"$xoops_rootpath/modules/tad_web/plugins/`$block.plugin.dirname`/tpls/b4/`$block.tpl`"}>
      <{/if}>
    <{else}>

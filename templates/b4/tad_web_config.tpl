      ...
      <div id='tad_web_config_tab-1'>
        <form action="config.php" method="post" enctype="multipart/form-data" class="form-horizontal myForm" role="form">
          <div class="row">
            ...
            <div class="col-md-5">
              <{if $teacher_thumb_pic}>
                <img src="<{$teacher_thumb_pic}>" alt="photo" class="rounded img-polaroid img-fluid img-thumbnail">
              <{/if}>
            </div>
          </div>
          ...
          <div class="row">
            ...
            </div><label class="col-md-2 col-form-label text-sm-right">
                ...
                <{else}>
                  <tr id="tr_<{$plugin.dirname}>">
                    <td <{if $plugin.db.PluginEnable=='0'}>style="background-color: #dfdfdf; color: #5f5f5f;"<{/if}>>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" id="plugin_enable_<{$plugin.dirname}>" type="checkbox" name="plugin_enable[<{$plugin.dirname}>]" value="1" <{if $plugin.db.PluginEnable=='1'}>checked="checked"<{elseif $plugin.db.PluginEnable=='0'}><{else}>checked="checked"<{/if}>>

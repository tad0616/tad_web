      ...
      <form action="block.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="radio-inline">
              <input type="radio" name="config[show_title]" value="0" <{if $block.config.show_title=='0'}>checked<{/if}>><{$smarty.const._NO}>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="radio-inline">
              <input type="radio" name="BlockEnable" value="1" <{if $block.BlockEnable!='0'}>checked<{/if}>><{$smarty.const._YES}>
            </div>
            <div class="radio-inline">
              <input type="radio" name="BlockEnable" value="0" <{if $block.BlockEnable=='0'}>checked<{/if}>><{$smarty.const._NO}>
            </div>
          </div>
        </div>
        ...
        <{if $block.plugin=="custom" or $op=="add_block"}>
          ...
          <{else}>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <div class="radio-inline">
                  <input type="radio" name="BlockShare" value="1" <{if $shareBlockID > 0}>checked<{/if}>><{$smarty.const._YES}>
                </div>
                <div class="radio-inline">
                  <input type="radio" name="BlockShare" value="0" <{if $shareBlockID == 0 or $block.BlockID==""}>checked<{/if}>><{$smarty.const._NO}>
                </div>
              </div>
            </div>
  ...
  <form action="block.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    <div class="alert alert-success">
      <label class="checkbox-inline">
        <input type="checkbox" name="use_block_pic" value="1" <{if $use_block_pic=="1"}>checked<{/if}>>
